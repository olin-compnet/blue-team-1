...
#
"""
    Alex, I modified one part of this so I could make my implementation simpler.
    I added self.n in RSA_public so I can access that value for key transmission
"""
...
opt=0 chooses plain exponentiation."""
    ...
    def decrypt(self,received_cyphertext):
        ...
        if opt==0:
            return plain_decrypt_init(received_cyphertext)
        elif opt==1:
            return crt_decrypt_init(received_cyphertext)
        else:
